const para111 = [`<div class="pagess" id="sura-fatihah">
                <div class="page-head">
            ...
            </div>`,`<div class="pagess" id="sura-bakara">
                <div class="page-head">
            ...
            for (para1 of para111) {
                document.querySelector("").innerHTML += para1;
