...
function speechToText() {
  try {
    ...
    recordBtn.querySelector("p").innerHTML = "আপনি পড়ছেন...";
    recognition.start();
    recognition.onresult = (event) => {
      ...
      if (event.results[0].isFinal) {
        ...
        document.querySelector("textarea#hidden").innerHTML += " " + speechResult;
...
function stopRecording() {
  recognition.stop();
  recordBtn.querySelector("p").innerHTML = "আপনি পড়েন";
